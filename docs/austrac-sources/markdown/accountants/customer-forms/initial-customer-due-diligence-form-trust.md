# Initial customer due diligence form – professional services: trust
...
- the identity of any beneficiaries of the client (see Section D4)
- the identity of any beneficial owners of the client (see Section D5)
...
This section establishes the identity of the client, any beneficial owners, any representatives, and persons on whose behalf the client is receiving a designated service (such as a beneficiary).
...
This section confirms if the client, their representatives, any beneficial owners, and any persons on whose behalf the client is receiving a designated service (such as beneficiaries) are a person subject to targeted financial sanctions or a politically exposed person (PEP). The search results may impact the client’s final risk rating and whether you need to refer the client to the AML/CTF compliance officer.
...
| The identity of any persons on whose behalf the client is receiving the service (i.e. beneficiaries) | [ ] | [ ] |
| The nature and purpose of the business relationship | [ ] | [ ] |
| Whether or not any beneficial owners, any representative and any person on whose behalf the client is receiving the service (i.e. beneficiaries) is a politically exposed person | [ ] | [ ] |
| Whether or not the client, any beneficial owners, any representative and any person on whose behalf the client is receiving the service (i.e. beneficiaries) are subject to targeted financial sanctions | [ ] | [ ] |
