# Initial customer due diligence form – professional services: government body
...
The identification documents provided must be one of the independent and reliable data sources contained in Appendix A of the client onboarding form. You may need to request additional identity documents if there are differences between the information the client gave you and their identity documents.
...
| Do you have any concerns about the validity of any document the client provided?<br>If YES, provide details. | [ ]   Yes     [ ]   No<br>Details: |
...
This section verifies the information provided at onboarding about the client’s representative(s). Insert additional tables if there is more than one client representative.
...
| Do you have concerns the information provided at onboarding about the client representative is untrue?<br>If YES, complete D2.2.<br>If NO, you do not need to complete D2.2. | [ ]   Yes     [ ]   No |
| --- | --- |
...
| Describe any steps you have taken, or will take, to resolve differences:<br>For example, requesting additional documents or contacting the client about the representative’s authority to act. |  |
| Is the client’s representative using alternative identification? Is the reason for providing alternative ID appropriate?<br>What steps will you take to manage and mitigate the associated ML/TF risk? | [ ]   Yes     [ ]   No<br>Reason alternative identification required:<br>Steps: |

Reference if no photo identification provided

If a client representative can’t provide photo ID, request a reference from a person who holds a position of trust in the community and has an existing relationship with the individual. The referee must confirm the person is who they claim to be. Attach any references.
...
This section confirms if the client, their representatives and any beneficial owners are a person subject to targeted financial sanctions or a politically exposed person (PEP). The search results may impact the client’s final risk rating and whether you need to refer the client to the AML/CTF compliance officer.
