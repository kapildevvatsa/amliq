# AML/CTF compliance officer and senior manager effectiveness check

This form helps the governing body assess the effectiveness of the AML/CTF compliance officer and senior manager. It ensures both roles have adequate authority, resources and oversight to meet your regulatory obligations.

#### Section 1: Review planning

| Period of review (quarter/date range): |  |
| :--- | :--- |
| Files and records selected for review (select all that apply): | [ ]   Suspicious matter report (SMR)<br>[ ]   Threshold transaction report (TTR)<br>[ ]   Enhanced customer due diligence (CDD) records<br>[ ]   AML/CTF program approvals<br>[ ]   High risk client approvals |
| File identification/references: |  |
| Selection rationale:<br>For example, recent incidents, random sample or governance cycle. |  |

#### Section 2: Compliance officer performance
...
| AUSTRAC reports submitted within required timeframes: | [ ]   Yes<br>[ ]   No |  |
| Records maintained in accordance with AML/CTF requirements: | [ ]   Yes<br>[ ]   No |  |
...
| Onboarding approvals for high risk and politically exposed persons (PEP) clients are documented: | [ ]   Yes<br>[ ]   No |  |
| Decisions to continue relationships with high risk clients are documented and have been reviewed and approved: | [ ]   Yes<br>[ ]   No |  |
