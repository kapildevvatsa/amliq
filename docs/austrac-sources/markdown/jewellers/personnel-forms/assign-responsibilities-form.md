...
- senior manager (SM)
- customer-facing personnel and other personnel with an AML/CTF function (CP).
...
| Make sure our business appoints a senior manager and AML/CTF compliance officer | X |  |  |  |
...
| Approve the decision to start or continue providing a regulated transaction to a customer where [enhanced CDD policy](#enhanced-customer-due-2) applies, including customers:<br>- that are a high ML/TF risk<br>- where a suspicious matter report needs to be submitted, and we decide to keep providing brokering services to the customer |  |  | X |  |
...
We have added an ‘X’ next to each column where we have suggested as to which obligation may be suitable for each role.
