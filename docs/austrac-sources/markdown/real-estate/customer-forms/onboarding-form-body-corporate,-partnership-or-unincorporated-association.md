...
| Is the customer registered with ASIC or another relevant domestic or foreign registration body? | [ ]   Yes     [ ]   No<br>Details: |
| Principal place of business address:<br>This is the main physical location the customer conducts their activities. |  |
| Registered office address (if different to principal place of business or operations): |  |
| Nature of the customer's business or operations:<br>For example, what sector does it operate in? What kinds of products and services does it offer? If it is not a commercial activity, what is the purpose of the customer? |  |
| What powers bind or govern the customer?<br>For example, the company’s constitution, a partnership agreement, replaceable rules from the Corporations Act. If rules have been replaced, what is the impact of those rules? |  |
| Is the customer one of, or otherwise controlled by: | [ ] A government body<br>Specify which body:<br>[ ] Subject to regulatory oversight by a prudential, insurance or investor protection regulator through registration or licensing requirements<br>Specify which regulator:<br>Specify the capacity in which they’re registered or licensed:<br>Specify any unique licensing or registration number:<br>[ ] A corporation or association of homeowners in a strata title or community title scheme |
| Is the customer a publicly listed company subject to public disclosure requirements that ensure transparency regarding the identity of beneficial owners?<br>If so, provide the name of the relevant stock exchange. | [ ]   Yes     [ ]   No<br>Name of stock exchange:<br>For example, ASX |
| What service is the customer seeking and why?<br>For example:<br>- brokering services to help sell residential real estate owned by the customer<br>- purchasing real estate as an investment. |  |
| If the customer is buying a property, are they using a mortgage, loan or other finance from a bank or lender? | [ ]   Yes     [ ]   No<br>If YES, Bank/lender name: |
| If the customer is buying a property, how are they paying for it?<br>If it is using a mortgage, loan, or other finance from a bank or lender, also indicate how it is paying the deposit.<br>Choose all that apply. | [ ]   Physical currency (cash) - specify amount to be paid:<br>[ ]   Virtual assets - specify amount to be paid:<br>[ ]   Electronic transfer<br>[ ]   Other (please specify): |

#### Section B: Customer representative details
...
| Do you have authority to act on behalf of the customer in relation to this service?<br>If so, where does the authority to act come from?<br>For example, a power of attorney, agency agreement, written authorisation from the customer. | [ ]   Yes     [ ]   No<br>Details of authority to act: |

#### Section C: Identity of beneficial owners

Our business will need information so that we can identify the individuals that are the beneficial owners of the body corporate, partnership or unincorporated association.
...
| If customer’s representative is regulated under the AML/CTF Act, evidence of their enrolment with AUSTRAC: |  |
...
| Information on the powers that bind and govern the customer:<br>For example, a copy of a constitution, partnership agreement, or identify if using the replaceable rules in the Corporations Act, any modifications made to those rules and their impact. |  |
| Information that shows the ownership and control structure of the customer.<br>For example:<br>- information on who owns the customer (any distribution of shares and the kind of shares distributed)<br>- documents showing control and decision-making processes<br>- a copy of the constitution, charter, rules, partnership agreement, distribution of member statements or other similar document. |  |
...
- a letter, agency agreement or other authorisation document from the customer establishing that the representative has authority to act
