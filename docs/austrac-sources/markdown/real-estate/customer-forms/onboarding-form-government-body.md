...
| Address of the government body’s principal place of business: |  |
| Evidence of government body’s existence:<br>For example, a law or executive decision or order that establishes an agency or an extract from an official government website. |  |
| What’s the nature of this body?<br>For example, what sector does it operate in or what is the nature of its activities. |  |
| What service is the government body seeking and why?<br>For example, brokering services to help sell commercial real estate, purchasing real estate to operate within. |  |
| If the government body is buying a property, are they using a mortgage, loan or other finance from a bank or lender? | [ ]   Yes     [ ]   No<br>If YES, Bank/lender name: |
| If the government body is buying a property, how are they paying for it?<br>If it is using a mortgage, loan, or other finance from a bank or lender, also indicate how it is paying the deposit.<br>Choose all that apply. | [ ]   Physical currency (cash) - specify amount to be paid:<br>[ ]   Virtual assets - specify amount to be paid:<br>[ ]   Electronic transfer<br>[ ]   Other (please specify): |
...
Provide one of the following for any representative:
...
If the individual uses a reference, the referee must be someone who both:
...
You must consider if the customer's representatives identified in the onboarding form are a politically exposed person.
