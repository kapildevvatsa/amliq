...
| If the trust is registered as a business, list the principal place of business address:<br>This is the main physical location the trust conducts their activities. |  |
| If the trust is registered as a business, list the registered office address (if different to principal place of business or operations): |  |
...
| What service is the trust seeking and why?<br>For example:<br>  - brokering services to help sell residential real estate I own<br>  - purchasing real estate as an investment. |  |
| If the trust is buying a property, are they using a mortgage, loan or other finance from a bank or lender? | [ ]   Yes     [ ]   No<br>If YES, Bank/lender name: |
| If the trust is buying a property, how are they paying for it?<br>If it is using a mortgage, loan, or other finance from a bank or lender, also indicate how it is paying the deposit.<br>Choose all that apply. | [ ]   Physical currency (cash) - specify amount to be paid:<br>[ ]   Virtual assets - specify amount to be paid:<br>[ ]   Electronic transfer<br>[ ]   Other (please specify): |
...
#### Section C: Identity of key position holders and other beneficial owners

Our business will need information so that we can identify the individuals that are the beneficial owners of the trust. These are the individuals who directly or indirectly either:
...
| Beneficiaries (if fewer than 10 beneficiaries) |  |  |  |  |  |  | [ ]   Yes     [ ]   No<br>Position:<br>Description of role: |  |

If there are any other beneficial owners not covered by the positions above, please provide information about those individuals in the following table.

If any of the position holders above are not individuals (for example, a company trustee), provide details of the individual beneficial owners of those position holders in this table. Add more rows if needed:
...
| Authority for any customer representative to act: |  |
...
| Evidence that the trust exists and shows the ownership and control structure of the trust:<br>This could be the trust deed (or equivalent instrument), a will or letter of administration.<br>For foreign trusts, also provide information on the legal framework the trust was established under. |  |
...
#### Identification documents for trusts
...
Provide one of the following for any representative and persons listed in Section C:
...
If an individual uses a reference, the referee must be someone who both:
...
You must consider if any representative and individuals identified in Section C of the onboarding form are a politically exposed person.
