...
const AMLiqData = {
  ...
  faq: [
    ...
    },
    {
      ...
      a: 'You must conduct CDD on your customer — the party to whom you are providing the designated service. If you are acting as a selling agent for the vendor, the vendor is your customer. If you are acting as a buyer\'s agent, the buyer is your customer. You should also consider whether the counterparty presents any risk.',
      topics: ['cdd'],
  ...
  // ─── AUSTRAC LINKS ────────────────────────────────────────────────────────
  austracLinks: [
    { title: 'Real Estate Guidance (main page)', url: 'https://www.austrac.gov.au/reforms/sector-specific-guidance/real-estate-guidance', desc: 'AUSTRAC\'s main guidance hub for real estate sector obligations.' },
    { title: 'Real Estate Program Starter Kit', url: 'https://www.austrac.gov.au/reforms/sector-specific-guidance/real-estate-guidance/real-estate-program-starter-kit', desc: 'The official starter kit — use this as your primary resource for building your AML/CTF program.' },
    { title: 'Starter Kit Document Library', url: 'https://www.austrac.gov.au/reforms/program-starter-kits/real-estate-guidance/real-estate-program-starter-kit/real-estate-program-starter-kit-document-library', desc: 'All template documents from the starter kit in one place.' },
    { title: 'Step 3: Maintain and Review', url: 'https://www.austrac.gov.au/reforms/sector-specific-guidance/real-estate-guidance/real-estate-program-starter-kit/step-3-maintain-and-review-your-real-estate-program', desc: 'AUSTRAC guidance on ongoing program maintenance and review obligations.' },
    { title: 'Risk Insights — Real Estate Suspicious Activity Indicators', url: 'https://www.austrac.gov.au/business/how-comply-guidance-and-resources/guidance-resources/risk-insights-and-indicators-suspicious-activity-real-estate-sector', desc: 'AUSTRAC\'s published red flag indicators and risk insights specific to the real estate sector.' },
    { title: 'Real Estate Services Reform Overview', url: 'https://www.austrac.gov.au/amlctf-reform/reforms-guidance/before-you-start/new-industries-and-services-be-regulated-reform/real-estate-services-reform', desc: 'Overview of how the reforms specifically affect real estate businesses.' },
    { title: 'Summary of Obligations — Tranche 2', url: 'https://www.austrac.gov.au/about-us/amlctf-reform/summary-amlctf-obligations-tranche-2-entities', desc: 'Summary of all AML/CTF obligations for newly regulated Tranche 2 entities.' },
    ...
    { title: 'Enhanced CDD (Reform)', url: 'https://www.austrac.gov.au/amlctf-reform/reforms-guidance/amlctf-program-reform/customer-due-diligence-reform/enhanced-customer-due-diligence-reform', desc: 'AUSTRAC guidance on when and how to apply Enhanced Due Diligence.' },
    { title: 'AML/CTF Compliance Officer (Reform)', url: 'https://www.austrac.gov.au/amlctf-reform/reforms-guidance/amlctf-program-reform/develop-your-amlctf-program-reform/step-1-establish-your-governance-framework-reform/amlctf-compliance-officer-reform', desc: 'AUSTRAC guidance on appointing and notifying your compliance officer.' },
    { title: 'Personnel Due Diligence & Training (Reform)', url: 'https://www.austrac.gov.au/amlctf-reform/reforms-guidance/amlctf-program-reform/personnel-due-diligence-and-training-reform/identifying-personnel-roles-require-due-diligence-and-training-reform', desc: 'Who requires due diligence and training, and what is required.' },
    { title: 'Suspicious Matter Reports (Reform)', url: 'https://www.austrac.gov.au/amlctf-reform/reforms-guidance/amlctf-program-reform/reporting-austrac-reform/suspicious-matter-reports-reform', desc: 'When and how to file Suspicious Matter Reports.' },
    { title: 'Threshold Transaction Reports (Reform)', url: 'https://www.austrac.gov.au/amlctf-reform/reforms-guidance/amlctf-program-reform/reporting-austrac-reform/threshold-transaction-reports-reform', desc: 'When and how to file Threshold Transaction Reports for physical cash.' },
    { title: 'Beneficial Owners', url: 'https://www.austrac.gov.au/business/core-guidance/customer-identification-and-verification/beneficial-owners', desc: 'How to identify and verify beneficial owners of entities.' },
    { title: 'Regulatory Expectations for Implementation', url: 'https://www.austrac.gov.au/austrac-regulatory-expectations-implementation-amlctf-reforms', desc: 'What AUSTRAC expects from newly regulated entities during implementation.' },
    { title: 'AUSTRAC Online (Enrolment & Reporting)', url: 'https://online.austrac.gov.au', desc: 'The AUSTRAC Online portal — where you enrol and file reports (SMRs, TTRs, IFTIs).' },
    { title: 'DFAT Consolidated Sanctions List', url: 'https://www.dfat.gov.au/international-relations/security/sanctions/consolidated-list', desc: 'The Australian Government\'s list of persons and entities subject to targeted financial sanctions. Check this for every customer.' },
    { title: 'Money Laundering National Risk Assessment 2024', url: 'https://www.austrac.gov.au/business/how-comply-guidance-and-resources/guidance-resources/money-laundering-australia-national-risk-assessment-2024', desc: 'AUSTRAC\'s 2024 assessment rating real estate as HIGH risk for money laundering.' },
  ],
